...
# Enumerations
# Classes
UPFFunctionGrp = Class(name="UPFFunctionGrp")
UPFFunction = Class(name="UPFFunction")

# UPFFunctionGrp class attributes and methods
UPFFunctionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
UPFFunctionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
UPFFunctionGrp_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
UPFFunctionGrp.attributes={UPFFunctionGrp_pLMNIdList, UPFFunctionGrp_managedNFProfile, UPFFunctionGrp_sNSSAIList}
