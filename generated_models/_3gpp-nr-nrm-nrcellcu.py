...
# Enumerations
# Classes
NRCellCUGrp = Class(name="NRCellCUGrp")
NRCellCU = Class(name="NRCellCU")

# NRCellCUGrp class attributes and methods
NRCellCUGrp_cellLocalId: Property = Property(name="cellLocalId", type=IntegerType)
NRCellCUGrp_nRFrequencyRef: Property = Property(name="nRFrequencyRef", type=types3gpp:DistinguishedName)
NRCellCUGrp_pLMNInfoList: Property = Property(name="pLMNInfoList", type=list)
NRCellCUGrp.attributes={NRCellCUGrp_cellLocalId, NRCellCUGrp_pLMNInfoList, NRCellCUGrp_nRFrequencyRef}
