...
# Enumerations
# Classes
NRSectorCarrierGrp = Class(name="NRSectorCarrierGrp")
NRSectorCarrier = Class(name="NRSectorCarrier")

# NRSectorCarrierGrp class attributes and methods
NRSectorCarrierGrp_txDirection: Property = Property(name="txDirection", type=types3gpp:TxDirection)
NRSectorCarrierGrp_configuredMaxTxPower: Property = Property(name="configuredMaxTxPower", type=IntegerType)
NRSectorCarrierGrp_configuredMaxTxEIRP: Property = Property(name="configuredMaxTxEIRP", type=IntegerType)
NRSectorCarrierGrp_arfcnDL: Property = Property(name="arfcnDL", type=IntegerType)
NRSectorCarrierGrp_arfcnUL: Property = Property(name="arfcnUL", type=IntegerType)
NRSectorCarrierGrp_bSChannelBwDL: Property = Property(name="bSChannelBwDL", type=IntegerType)
NRSectorCarrierGrp_bSChannelBwUL: Property = Property(name="bSChannelBwUL", type=IntegerType)
NRSectorCarrierGrp_sectorEquipmentFunctionRef: Property = Property(name="sectorEquipmentFunctionRef", type=types3gpp:DistinguishedName)
NRSectorCarrierGrp.attributes={NRSectorCarrierGrp_configuredMaxTxEIRP, NRSectorCarrierGrp_configuredMaxTxPower, NRSectorCarrierGrp_txDirection, NRSectorCarrierGrp_bSChannelBwDL, NRSectorCarrierGrp_sectorEquipmentFunctionRef, NRSectorCarrierGrp_arfcnDL, NRSectorCarrierGrp_bSChannelBwUL, NRSectorCarrierGrp_arfcnUL}
