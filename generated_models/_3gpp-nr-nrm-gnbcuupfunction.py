...
# Enumerations
# Classes
TAIGrp = Class(name="TAIGrp")
BackhaulAddressGrp = Class(name="BackhaulAddressGrp")
MappingSetIDBackhaulAddressGrp = Class(name="MappingSetIDBackhaulAddressGrp")
GNBCUUPFunctionGrp = Class(name="GNBCUUPFunctionGrp")
GNBCUUPFunction = Class(name="GNBCUUPFunction")

# TAIGrp class attributes and methods
TAIGrp_nRTAC: Property = Property(name="nRTAC", type=IntegerType)
TAIGrp_pLMNId: Property = Property(name="pLMNId", type=list)
TAIGrp.attributes={TAIGrp_nRTAC, TAIGrp_pLMNId}

# BackhaulAddressGrp class attributes and methods
BackhaulAddressGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
BackhaulAddressGrp_tAI: Property = Property(name="tAI", type=list)
BackhaulAddressGrp.attributes={BackhaulAddressGrp_tAI, BackhaulAddressGrp_gNBId}

# MappingSetIDBackhaulAddressGrp class attributes and methods
MappingSetIDBackhaulAddressGrp_idx: Property = Property(name="idx", type=IntegerType)
MappingSetIDBackhaulAddressGrp_setID: Property = Property(name="setID", type=IntegerType)
MappingSetIDBackhaulAddressGrp_backhaulAddress: Property = Property(name="backhaulAddress", type=list)
MappingSetIDBackhaulAddressGrp.attributes={MappingSetIDBackhaulAddressGrp_idx, MappingSetIDBackhaulAddressGrp_setID, MappingSetIDBackhaulAddressGrp_backhaulAddress}

# GNBCUUPFunctionGrp class attributes and methods
GNBCUUPFunctionGrp_gNBCUUPId: Property = Property(name="gNBCUUPId", type=IntegerType)
GNBCUUPFunctionGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
GNBCUUPFunctionGrp_gNBIdLength: Property = Property(name="gNBIdLength", type=IntegerType)
GNBCUUPFunctionGrp_configurable5QISetRef: Property = Property(name="configurable5QISetRef", type=types3gpp:DistinguishedName)
GNBCUUPFunctionGrp_dynamic5QISetRef: Property = Property(name="dynamic5QISetRef", type=types3gpp:DistinguishedName)
GNBCUUPFunctionGrp_pLMNInfoList: Property = Property(name="pLMNInfoList", type=list)
GNBCUUPFunctionGrp_mappingSetIDBackhaulAddressList: Property = Property(name="mappingSetIDBackhaulAddressList", type=list)
GNBCUUPFunctionGrp.attributes={GNBCUUPFunctionGrp_gNBCUUPId, GNBCUUPFunctionGrp_pLMNInfoList, GNBCUUPFunctionGrp_gNBId, GNBCUUPFunctionGrp_gNBIdLength, GNBCUUPFunctionGrp_dynamic5QISetRef, GNBCUUPFunctionGrp_mappingSetIDBackhaulAddressList, GNBCUUPFunctionGrp_configurable5QISetRef}
...
GNBCUUPFunction.attributes={GNBCUUPFunction_gNBCUUPId, GNBCUUPFunction_pLMNInfoList, GNBCUUPFunction_gNBId, GNBCUUPFunction_gNBIdLength, GNBCUUPFunction_dynamic5QISetRef, GNBCUUPFunction_mappingSetIDBackhaulAddressList, GNBCUUPFunction_configurable5QISetRef}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-gnbcuupfunction",
    types={TAIGrp, BackhaulAddressGrp, MappingSetIDBackhaulAddressGrp, GNBCUUPFunctionGrp, GNBCUUPFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model},
    associations={},
    generalizations={}
)
