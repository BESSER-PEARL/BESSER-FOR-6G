...
# Enumerations
# Classes
ExternalServingGWFunctionGrp = Class(name="ExternalServingGWFunctionGrp")
ExternalServingGWFunctionWrapper = Class(name="ExternalServingGWFunctionWrapper")

# ExternalServingGWFunctionGrp class attributes and methods
