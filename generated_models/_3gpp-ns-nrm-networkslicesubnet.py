...
# Enumerations
# Classes
EPTransportGrp = Class(name="EPTransportGrp")
NsInfoGrp = Class(name="NsInfoGrp")
NetworkSliceSubnetGrp = Class(name="NetworkSliceSubnetGrp")

# EPTransportGrp class attributes and methods
EPTransportGrp_ipAddress: Property = Property(name="ipAddress", type=StringType)
EPTransportGrp_logicInterfaceId: Property = Property(name="logicInterfaceId", type=StringType)
EPTransportGrp.attributes={EPTransportGrp_logicInterfaceId, EPTransportGrp_ipAddress}

# NsInfoGrp class attributes and methods
NsInfoGrp_nSInstanceId: Property = Property(name="nSInstanceId", type=ETSI-GS-NFV-Identifier)
NsInfoGrp_nsName: Property = Property(name="nsName", type=StringType)
NsInfoGrp_description: Property = Property(name="description", type=StringType)
NsInfoGrp.attributes={NsInfoGrp_nsName, NsInfoGrp_description, NsInfoGrp_nSInstanceId}

# NetworkSliceSubnetGrp class attributes and methods
NetworkSliceSubnetGrp_operationalState: Property = Property(name="operationalState", type=types3gpp:OperationalState)
NetworkSliceSubnetGrp_administrativeState: Property = Property(name="administrativeState", type=types3gpp:AdministrativeState)
NetworkSliceSubnetGrp_nsInfo: Property = Property(name="nsInfo", type=list)
NetworkSliceSubnetGrp_sliceProfileList: Property = Property(name="sliceProfileList", type=list)
NetworkSliceSubnetGrp_managedFunctionRef: Property = Property(name="managedFunctionRef", type=list)
NetworkSliceSubnetGrp.attributes={NetworkSliceSubnetGrp_nsInfo, NetworkSliceSubnetGrp_operationalState, NetworkSliceSubnetGrp_sliceProfileList, NetworkSliceSubnetGrp_managedFunctionRef, NetworkSliceSubnetGrp_administrativeState}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-ns-nrm-networkslicesubnet",
    types={EPTransportGrp, NsInfoGrp, NetworkSliceSubnetGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model, nss3gpp_model},
    associations={},
    generalizations={}
)
