...
# Enumerations
# Classes
rRMPolicyMemberGrp = Class(name="rRMPolicyMemberGrp")
RRMPolicy_Grp = Class(name="RRMPolicy_Grp")
RRMPolicyRatioGrp = Class(name="RRMPolicyRatioGrp")

# rRMPolicyMemberGrp class attributes and methods

# RRMPolicy_Grp class attributes and methods
RRMPolicy_Grp_resourceType: Property = Property(name="resourceType", type=StringType)
RRMPolicy_Grp_rRMPolicyMemberList: Property = Property(name="rRMPolicyMemberList", type=list)
RRMPolicy_Grp.attributes={RRMPolicy_Grp_rRMPolicyMemberList, RRMPolicy_Grp_resourceType}

# RRMPolicyRatioGrp class attributes and methods
RRMPolicyRatioGrp_rRMPolicyMaxRatio: Property = Property(name="rRMPolicyMaxRatio", type=IntegerType)
RRMPolicyRatioGrp_rRMPolicyMinRatio: Property = Property(name="rRMPolicyMinRatio", type=IntegerType)
RRMPolicyRatioGrp_rRMPolicyDedicatedRatio: Property = Property(name="rRMPolicyDedicatedRatio", type=IntegerType)
RRMPolicyRatioGrp.attributes={RRMPolicyRatioGrp_rRMPolicyDedicatedRatio, RRMPolicyRatioGrp_rRMPolicyMaxRatio, RRMPolicyRatioGrp_rRMPolicyMinRatio}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-rrmpolicy",
    types={rRMPolicyMemberGrp, RRMPolicy_Grp, RRMPolicyRatioGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model},
    associations={},
    generalizations={}
)
