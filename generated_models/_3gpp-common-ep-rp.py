...
# Enumerations
# Classes
EP_RPGrp = Class(name="EP_RPGrp")
EP_Common = Class(name="EP_Common")

# EP_RPGrp class attributes and methods
EP_RPGrp_userLabel: Property = Property(name="userLabel", type=StringType)
EP_RPGrp_farEndEntity: Property = Property(name="farEndEntity", type=types3gpp:DistinguishedName)
EP_RPGrp.attributes={EP_RPGrp_userLabel, EP_RPGrp_farEndEntity}
...
domain_model = DomainModel(
    ...
    types={EP_RPGrp, EP_Common, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model},
    associations={},
    generalizations={}
)
