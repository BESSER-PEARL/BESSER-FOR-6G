...
# Enumerations
# Classes
Domain_Grp = Class(name="Domain_Grp")
SubNetworkGrp = Class(name="SubNetworkGrp")

# Domain_Grp class attributes and methods
Domain_Grp_dnPrefix: Property = Property(name="dnPrefix", type=types3gpp:DistinguishedName)
Domain_Grp_userLabel: Property = Property(name="userLabel", type=StringType)
Domain_Grp_userDefinedNetworkType: Property = Property(name="userDefinedNetworkType", type=StringType)
Domain_Grp.attributes={Domain_Grp_userLabel, Domain_Grp_userDefinedNetworkType, Domain_Grp_dnPrefix}

# SubNetworkGrp class attributes and methods
SubNetworkGrp_priorityLabel: Property = Property(name="priorityLabel", type=IntegerType)
SubNetworkGrp.attributes={SubNetworkGrp_priorityLabel}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-common-subnetwork",
    types={Domain_Grp, SubNetworkGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model},
    associations={},
    generalizations={}
)
