...
# Enumerations
# Classes
GNBDUFunctionGrp = Class(name="GNBDUFunctionGrp")
GNBDUFunction = Class(name="GNBDUFunction")

# GNBDUFunctionGrp class attributes and methods
GNBDUFunctionGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
GNBDUFunctionGrp_gNBIdLength: Property = Property(name="gNBIdLength", type=IntegerType)
GNBDUFunctionGrp_gNBDUId: Property = Property(name="gNBDUId", type=IntegerType)
GNBDUFunctionGrp_gNBDUName: Property = Property(name="gNBDUName", type=StringType)
GNBDUFunctionGrp_aggressorSetID: Property = Property(name="aggressorSetID", type=IntegerType)
GNBDUFunctionGrp_victimSetID: Property = Property(name="victimSetID", type=IntegerType)
GNBDUFunctionGrp.attributes={GNBDUFunctionGrp_gNBIdLength, GNBDUFunctionGrp_gNBDUId, GNBDUFunctionGrp_aggressorSetID, GNBDUFunctionGrp_gNBDUName, GNBDUFunctionGrp_gNBId, GNBDUFunctionGrp_victimSetID}
...
GNBDUFunction.attributes={GNBDUFunction_gNBIdLength, GNBDUFunction_gNBDUId, GNBDUFunction_aggressorSetID, GNBDUFunction_gNBDUName, GNBDUFunction_gNBId, GNBDUFunction_victimSetID}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-gnbdufunction",
    types={GNBDUFunctionGrp, GNBDUFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model},
    associations={},
    generalizations={}
)
