...
# Enumerations
CyclicPrefix: Enumeration = Enumeration(
    name="CyclicPrefix",
    literals={
            EnumerationLiteral(name="NORMAL"),
			EnumerationLiteral(name="EXTENDED")
    }
)

BwpContext: Enumeration = Enumeration(
    name="BwpContext",
    literals={
            EnumerationLiteral(name="DL"),
			EnumerationLiteral(name="UL"),
			EnumerationLiteral(name="SUL")
    }
)

IsInitialBwp: Enumeration = Enumeration(
    name="IsInitialBwp",
    literals={
...
# Classes
BWPGrp = Class(name="BWPGrp")
BWP = Class(name="BWP")

# BWPGrp class attributes and methods
BWPGrp_bwpContext: Property = Property(name="bwpContext", type=BwpContext)
BWPGrp_isInitialBwp: Property = Property(name="isInitialBwp", type=IsInitialBwp)
BWPGrp_subCarrierSpacing: Property = Property(name="subCarrierSpacing", type=IntegerType)
BWPGrp_cyclicPrefix: Property = Property(name="cyclicPrefix", type=CyclicPrefix)
BWPGrp_startRB: Property = Property(name="startRB", type=IntegerType)
BWPGrp_numberOfRBs: Property = Property(name="numberOfRBs", type=IntegerType)
BWPGrp.attributes={BWPGrp_subCarrierSpacing, BWPGrp_numberOfRBs, BWPGrp_isInitialBwp, BWPGrp_cyclicPrefix, BWPGrp_bwpContext, BWPGrp_startRB}
...
BWP.attributes={BWP_subCarrierSpacing, BWP_numberOfRBs, BWP_isInitialBwp, BWP_cyclicPrefix, BWP_bwpContext, BWP_startRB}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-bwp",
    types={BWPGrp, BWP, CyclicPrefix, BwpContext, IsInitialBwp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model},
    associations={},
    generalizations={}
)
