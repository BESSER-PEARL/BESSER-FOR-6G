...
# Enumerations
# Classes
DPCIConfigurationFunctionGrp = Class(name="DPCIConfigurationFunctionGrp")
NRPciListGrp = Class(name="NRPciListGrp")

# DPCIConfigurationFunctionGrp class attributes and methods
DPCIConfigurationFunctionGrp_dPciConfigurationControl: Property = Property(name="dPciConfigurationControl", type=BooleanType)
DPCIConfigurationFunctionGrp_nRPciList: Property = Property(name="nRPciList", type=list)
DPCIConfigurationFunctionGrp.attributes={DPCIConfigurationFunctionGrp_nRPciList, DPCIConfigurationFunctionGrp_dPciConfigurationControl}

# NRPciListGrp class attributes and methods
NRPciListGrp_NRPci: Property = Property(name="NRPci", type=IntegerType)
NRPciListGrp.attributes={NRPciListGrp_NRPci}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-dpciconfigurationfunction",
    types={DPCIConfigurationFunctionGrp, NRPciListGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model},
    associations={},
    generalizations={}
)
