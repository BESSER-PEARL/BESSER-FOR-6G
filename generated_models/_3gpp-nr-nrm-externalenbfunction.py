...
# Enumerations
# Classes
ExternalENBFunctionGrp = Class(name="ExternalENBFunctionGrp")
ExternalENBFunctionWrapper = Class(name="ExternalENBFunctionWrapper")

# ExternalENBFunctionGrp class attributes and methods
ExternalENBFunctionGrp_eNBId: Property = Property(name="eNBId", type=IntegerType)
ExternalENBFunctionGrp.attributes={ExternalENBFunctionGrp_eNBId}
