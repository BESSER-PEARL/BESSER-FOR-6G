...
# Enumerations
# Classes
ExternalGNBDUFunctionGrp = Class(name="ExternalGNBDUFunctionGrp")
ExternalGNBDUFunctionWrapper = Class(name="ExternalGNBDUFunctionWrapper")

# ExternalGNBDUFunctionGrp class attributes and methods
ExternalGNBDUFunctionGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
ExternalGNBDUFunctionGrp_gNBIdLength: Property = Property(name="gNBIdLength", type=IntegerType)
ExternalGNBDUFunctionGrp_pLMNId: Property = Property(name="pLMNId", type=list)
ExternalGNBDUFunctionGrp.attributes={ExternalGNBDUFunctionGrp_gNBId, ExternalGNBDUFunctionGrp_pLMNId, ExternalGNBDUFunctionGrp_gNBIdLength}
