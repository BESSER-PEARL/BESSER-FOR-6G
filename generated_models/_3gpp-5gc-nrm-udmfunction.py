...
# Enumerations
# Classes
UDMFuntionGrp = Class(name="UDMFuntionGrp")
UDMFunction = Class(name="UDMFunction")

# UDMFuntionGrp class attributes and methods
UDMFuntionGrp_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
UDMFuntionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
UDMFuntionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
UDMFuntionGrp_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
UDMFuntionGrp_commModelList: Property = Property(name="commModelList", type=list)
UDMFuntionGrp.attributes={UDMFuntionGrp_commModelList, UDMFuntionGrp_sBIFQDN, UDMFuntionGrp_pLMNIdList, UDMFuntionGrp_sNSSAIList, UDMFuntionGrp_managedNFProfile}

# UDMFunction class attributes and methods
UDMFunction_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
UDMFunction_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
UDMFunction_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
UDMFunction_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
UDMFunction_commModelList: Property = Property(name="commModelList", type=list)
UDMFunction.attributes={UDMFunction_commModelList, UDMFunction_sBIFQDN, UDMFunction_pLMNIdList, UDMFunction_sNSSAIList, UDMFunction_managedNFProfile}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-udmfunction",
    types={UDMFuntionGrp, UDMFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model},
    associations={},
    generalizations={}
)
