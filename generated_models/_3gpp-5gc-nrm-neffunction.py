...
# Enumerations
# Classes
NEFFunctionGrp = Class(name="NEFFunctionGrp")
NEFFunction = Class(name="NEFFunction")

# NEFFunctionGrp class attributes and methods
NEFFunctionGrp_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
...
NEFFunctionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
NEFFunctionGrp.attributes={NEFFunctionGrp_sBIFQDN, NEFFunctionGrp_sNSSAIList, NEFFunctionGrp_isINEF, NEFFunctionGrp_isCAPIFSup}
...
NEFFunction.attributes={NEFFunction_sBIFQDN, NEFFunction_sNSSAIList, NEFFunction_isINEF, NEFFunction_isCAPIFSup}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-neffunction",
    types={NEFFunctionGrp, NEFFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model},
    associations={},
    generalizations={}
)
