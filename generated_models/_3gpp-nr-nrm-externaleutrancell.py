...
# Enumerations
# Classes
ExternalEUtranGenericCellGrp = Class(name="ExternalEUtranGenericCellGrp")
ExternalEUtranCellFDDGrp = Class(name="ExternalEUtranCellFDDGrp")
ExternalEUtranCellTDDGrp = Class(name="ExternalEUtranCellTDDGrp")
...
# ExternalEUtranGenericCellGrp class attributes and methods
ExternalEUtranGenericCellGrp_pci: Property = Property(name="pci", type=IntegerType)
ExternalEUtranGenericCellGrp_cellLocalId: Property = Property(name="cellLocalId", type=IntegerType)
ExternalEUtranGenericCellGrp_eNBId: Property = Property(name="eNBId", type=IntegerType)
ExternalEUtranGenericCellGrp_plmnIdList: Property = Property(name="plmnIdList", type=list)
ExternalEUtranGenericCellGrp.attributes={ExternalEUtranGenericCellGrp_cellLocalId, ExternalEUtranGenericCellGrp_pci, ExternalEUtranGenericCellGrp_plmnIdList, ExternalEUtranGenericCellGrp_eNBId}

# ExternalEUtranCellFDDGrp class attributes and methods
ExternalEUtranCellFDDGrp_earfcnDL: Property = Property(name="earfcnDL", type=IntegerType)
ExternalEUtranCellFDDGrp_earfcnUL: Property = Property(name="earfcnUL", type=IntegerType)
ExternalEUtranCellFDDGrp.attributes={ExternalEUtranCellFDDGrp_earfcnUL, ExternalEUtranCellFDDGrp_earfcnDL}

# ExternalEUtranCellTDDGrp class attributes and methods
ExternalEUtranCellTDDGrp_earfcn: Property = Property(name="earfcn", type=IntegerType)
ExternalEUtranCellTDDGrp.attributes={ExternalEUtranCellTDDGrp_earfcn}
...
domain_model = DomainModel(
    ...
    types={ExternalEUtranGenericCellGrp, ExternalEUtranCellFDDGrp, ExternalEUtranCellTDDGrp, ExternalEUtranCellFDDWrapper, ExternalEUtranCellTDDWrapper, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model},
    associations={},
    generalizations={}
)
