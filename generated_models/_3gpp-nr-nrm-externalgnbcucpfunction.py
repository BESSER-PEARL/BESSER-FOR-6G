...
# Enumerations
# Classes
ExternalGNBCUCPFunctionGrp = Class(name="ExternalGNBCUCPFunctionGrp")
ExternalGNBCUCPFunctionWrapper = Class(name="ExternalGNBCUCPFunctionWrapper")

# ExternalGNBCUCPFunctionGrp class attributes and methods
ExternalGNBCUCPFunctionGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
ExternalGNBCUCPFunctionGrp_gNBIdLength: Property = Property(name="gNBIdLength", type=IntegerType)
ExternalGNBCUCPFunctionGrp_pLMNId: Property = Property(name="pLMNId", type=list)
ExternalGNBCUCPFunctionGrp.attributes={ExternalGNBCUCPFunctionGrp_gNBIdLength, ExternalGNBCUCPFunctionGrp_pLMNId, ExternalGNBCUCPFunctionGrp_gNBId}
