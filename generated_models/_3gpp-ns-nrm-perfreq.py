...
from generated_models._3gpp_ns_nrm_networkslicesubnet import domain_model as nss3gpp_model

# Enumerations
# Classes
PerfReqGrp = Class(name="PerfReqGrp")

# PerfReqGrp class attributes and methods
PerfReqGrp_expDataRateDL: Property = Property(name="expDataRateDL", type=data-rate)
PerfReqGrp_expDataRateUL: Property = Property(name="expDataRateUL", type=data-rate)
PerfReqGrp_areaTrafficCapDL: Property = Property(name="areaTrafficCapDL", type=data-rate)
PerfReqGrp_areaTrafficCapUL: Property = Property(name="areaTrafficCapUL", type=data-rate)
PerfReqGrp_overallUserDensity: Property = Property(name="overallUserDensity", type=IntegerType)
PerfReqGrp_activityFactor: Property = Property(name="activityFactor", type=integer-percentage)
PerfReqGrp_cSAvailabilityTarget: Property = Property(name="cSAvailabilityTarget", type=FloatType)
PerfReqGrp_cSReliabilityMeanTime: Property = Property(name="cSReliabilityMeanTime", type=reliability-string)
PerfReqGrp_expDataRate: Property = Property(name="expDataRate", type=data-rate)
PerfReqGrp_msgSizeByte: Property = Property(name="msgSizeByte", type=message-size-string)
PerfReqGrp_transferIntervalTarget: Property = Property(name="transferIntervalTarget", type=transfer-interval-string)
PerfReqGrp_survivalTime: Property = Property(name="survivalTime", type=survival-time-string)
PerfReqGrp.attributes={PerfReqGrp_survivalTime, PerfReqGrp_expDataRate, PerfReqGrp_cSReliabilityMeanTime, PerfReqGrp_areaTrafficCapUL, PerfReqGrp_areaTrafficCapDL, PerfReqGrp_activityFactor, PerfReqGrp_transferIntervalTarget, PerfReqGrp_expDataRateUL, PerfReqGrp_expDataRateDL, PerfReqGrp_overallUserDensity, PerfReqGrp_msgSizeByte, PerfReqGrp_cSAvailabilityTarget}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-ns-nrm-perfreq",
    types={PerfReqGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model, nss3gpp_model},
    associations={},
    generalizations={}
)
