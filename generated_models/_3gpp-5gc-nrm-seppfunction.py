...
# Enumerations
SEPPType: Enumeration = Enumeration(
    name="SEPPType",
    literals={
            EnumerationLiteral(name="CSEPP"),
			EnumerationLiteral(name="PSEPP")
    }
)
...
SEPPFunctionGrp_sEPPType: Property = Property(name="sEPPType", type=sepp3gpp:SEPPType)
SEPPFunctionGrp_sEPPId: Property = Property(name="sEPPId", type=IntegerType)
SEPPFunctionGrp_fqdn: Property = Property(name="fqdn", type=inet:domain-name)
SEPPFunctionGrp.attributes={SEPPFunctionGrp_sEPPType, SEPPFunctionGrp_fqdn, SEPPFunctionGrp_sEPPId}
...
SEPPFunction.attributes={SEPPFunction_sEPPType, SEPPFunction_fqdn, SEPPFunction_sEPPId}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-seppfunction",
    types={SEPPFunctionGrp, SEPPFunction, SEPPType, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model},
    associations={},
    generalizations={}
)
