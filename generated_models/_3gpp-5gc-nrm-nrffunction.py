...
# Enumerations
# Classes
NRFFunctionGrp = Class(name="NRFFunctionGrp")
NRFFunction = Class(name="NRFFunction")

# NRFFunctionGrp class attributes and methods
NRFFunctionGrp_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
NRFFunctionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
NRFFunctionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
NRFFunctionGrp_nFProfileList: Property = Property(name="nFProfileList", type=list)
NRFFunctionGrp.attributes={NRFFunctionGrp_pLMNIdList, NRFFunctionGrp_nFProfileList, NRFFunctionGrp_sBIFQDN, NRFFunctionGrp_sNSSAIList}
...
NRFFunction.attributes={NRFFunction_pLMNIdList, NRFFunction_sBIFQDN, NRFFunction_nFProfileList, NRFFunction_sNSSAIList}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-nrffunction",
    types={NRFFunctionGrp, NRFFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model},
    associations={},
    generalizations={}
)
