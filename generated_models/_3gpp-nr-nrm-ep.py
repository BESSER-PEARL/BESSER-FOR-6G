...
# Enumerations
# Classes
EP_E1Grp = Class(name="EP_E1Grp")
EP_F1CGrp = Class(name="EP_F1CGrp")
EP_F1UGrp = Class(name="EP_F1UGrp")
EP_XnCGrp = Class(name="EP_XnCGrp")
EP_XnUGrp = Class(name="EP_XnUGrp")
EP_NgCGrp = Class(name="EP_NgCGrp")
EP_NgUGrp = Class(name="EP_NgUGrp")
EP_X2CGrp = Class(name="EP_X2CGrp")
EP_X2UGrp = Class(name="EP_X2UGrp")
EP_S1UGrp = Class(name="EP_S1UGrp")
...
domain_model = DomainModel(
    ...
    types={EP_E1Grp, EP_F1CGrp, EP_F1UGrp, EP_XnCGrp, EP_XnUGrp, EP_NgCGrp, EP_NgUGrp, EP_X2CGrp, EP_X2UGrp, EP_S1UGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model},
    associations={},
    generalizations={}
)
