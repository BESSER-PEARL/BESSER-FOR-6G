...
# Enumerations
# Classes
PCFFuntionGrp = Class(name="PCFFuntionGrp")
PCFFunction = Class(name="PCFFunction")

# PCFFuntionGrp class attributes and methods
PCFFuntionGrp_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
PCFFuntionGrp_dynamic5QISetRef: Property = Property(name="dynamic5QISetRef", type=types3gpp:DistinguishedName)
PCFFuntionGrp_configurable5QISetRef: Property = Property(name="configurable5QISetRef", type=types3gpp:DistinguishedName)
PCFFuntionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
PCFFuntionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
PCFFuntionGrp_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
PCFFuntionGrp_commModelList: Property = Property(name="commModelList", type=list)
PCFFuntionGrp.attributes={PCFFuntionGrp_configurable5QISetRef, PCFFuntionGrp_pLMNIdList, PCFFuntionGrp_sNSSAIList, PCFFuntionGrp_sBIFQDN, PCFFuntionGrp_managedNFProfile, PCFFuntionGrp_commModelList, PCFFuntionGrp_dynamic5QISetRef}

# PCFFunction class attributes and methods
PCFFunction_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
PCFFunction_dynamic5QISetRef: Property = Property(name="dynamic5QISetRef", type=types3gpp:DistinguishedName)
PCFFunction_configurable5QISetRef: Property = Property(name="configurable5QISetRef", type=types3gpp:DistinguishedName)
PCFFunction_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
PCFFunction_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
PCFFunction_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
PCFFunction_commModelList: Property = Property(name="commModelList", type=list)
PCFFunction.attributes={PCFFunction_configurable5QISetRef, PCFFunction_pLMNIdList, PCFFunction_sNSSAIList, PCFFunction_sBIFQDN, PCFFunction_managedNFProfile, PCFFunction_commModelList, PCFFunction_dynamic5QISetRef}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-pcffunction",
    types={PCFFuntionGrp, PCFFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model},
    associations={},
    generalizations={}
)
