...
# Enumerations
ActionAllowed: Enumeration = Enumeration(
    name="ActionAllowed",
    literals={
...
EnergySavingCoverage: Enumeration = Enumeration(
...
# Classes
EUtranCellRelationGrp = Class(name="EUtranCellRelationGrp")
EUtranCellRelation = Class(name="EUtranCellRelation")

# EUtranCellRelationGrp class attributes and methods
EUtranCellRelationGrp_tCI: Property = Property(name="tCI", type=IntegerType)
EUtranCellRelationGrp_isRemoveAllowed: Property = Property(name="isRemoveAllowed", type=ActionAllowed)
EUtranCellRelationGrp_isHOAllowed: Property = Property(name="isHOAllowed", type=ActionAllowed)
EUtranCellRelationGrp_isENDCAllowed: Property = Property(name="isENDCAllowed", type=ActionAllowed)
EUtranCellRelationGrp_isICICInformationSendAllowed: Property = Property(name="isICICInformationSendAllowed", type=ActionAllowed)
EUtranCellRelationGrp_isLBAllowed: Property = Property(name="isLBAllowed", type=ActionAllowed)
EUtranCellRelationGrp_isESCoveredBy: Property = Property(name="isESCoveredBy", type=EnergySavingCoverage)
EUtranCellRelationGrp_qOffset: Property = Property(name="qOffset", type=types3gpp:QOffsetRange)
EUtranCellRelationGrp_cellIndividualOffset: Property = Property(name="cellIndividualOffset", type=types3gpp:QOffsetRange)
EUtranCellRelationGrp_adjacentCell: Property = Property(name="adjacentCell", type=types3gpp:DistinguishedName)
EUtranCellRelationGrp.attributes={EUtranCellRelationGrp_qOffset, EUtranCellRelationGrp_isICICInformationSendAllowed, EUtranCellRelationGrp_adjacentCell, EUtranCellRelationGrp_isENDCAllowed, EUtranCellRelationGrp_cellIndividualOffset, EUtranCellRelationGrp_isLBAllowed, EUtranCellRelationGrp_isHOAllowed, EUtranCellRelationGrp_isRemoveAllowed, EUtranCellRelationGrp_tCI, EUtranCellRelationGrp_isESCoveredBy}
