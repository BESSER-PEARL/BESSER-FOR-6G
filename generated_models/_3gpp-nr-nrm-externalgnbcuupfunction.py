...
# Enumerations
# Classes
ExternalGNBCUUPFunctionGrp = Class(name="ExternalGNBCUUPFunctionGrp")
ExternalGNBCUUPFunctionWrapper = Class(name="ExternalGNBCUUPFunctionWrapper")

# ExternalGNBCUUPFunctionGrp class attributes and methods
ExternalGNBCUUPFunctionGrp_gNBId: Property = Property(name="gNBId", type=IntegerType)
ExternalGNBCUUPFunctionGrp_gNBIdLength: Property = Property(name="gNBIdLength", type=IntegerType)
ExternalGNBCUUPFunctionGrp.attributes={ExternalGNBCUUPFunctionGrp_gNBId, ExternalGNBCUUPFunctionGrp_gNBIdLength}
