...
# Enumerations
# Classes
NGEIRFunctionGrp = Class(name="NGEIRFunctionGrp")
NGEIRFunction = Class(name="NGEIRFunction")

# NGEIRFunctionGrp class attributes and methods
NGEIRFunctionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
NGEIRFunctionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
NGEIRFunctionGrp_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
NGEIRFunctionGrp_commModelList: Property = Property(name="commModelList", type=list)
NGEIRFunctionGrp.attributes={NGEIRFunctionGrp_managedNFProfile, NGEIRFunctionGrp_pLMNIdList, NGEIRFunctionGrp_commModelList, NGEIRFunctionGrp_sNSSAIList}
...
NGEIRFunction.attributes={NGEIRFunction_managedNFProfile, NGEIRFunction_pLMNIdList, NGEIRFunction_commModelList, NGEIRFunction_sNSSAIList}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-ngeirfunction",
    types={NGEIRFunctionGrp, NGEIRFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model},
    associations={},
    generalizations={}
)
