...
# Enumerations
# Classes
UDRFuntionGrp = Class(name="UDRFuntionGrp")
UDRFunction = Class(name="UDRFunction")

# UDRFuntionGrp class attributes and methods
UDRFuntionGrp_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
UDRFuntionGrp_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
UDRFuntionGrp_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
UDRFuntionGrp_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
UDRFuntionGrp.attributes={UDRFuntionGrp_pLMNIdList, UDRFuntionGrp_managedNFProfile, UDRFuntionGrp_sBIFQDN, UDRFuntionGrp_sNSSAIList}

# UDRFunction class attributes and methods
UDRFunction_sBIFQDN: Property = Property(name="sBIFQDN", type=inet:domain-name)
UDRFunction_pLMNIdList: Property = Property(name="pLMNIdList", type=list)
UDRFunction_sNSSAIList: Property = Property(name="sNSSAIList", type=list)
UDRFunction_managedNFProfile: Property = Property(name="managedNFProfile", type=list)
UDRFunction.attributes={UDRFunction_pLMNIdList, UDRFunction_managedNFProfile, UDRFunction_sBIFQDN, UDRFunction_sNSSAIList}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-5gc-nrm-udrfunction",
    types={UDRFuntionGrp, UDRFunction, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model},
    associations={},
    generalizations={}
)
