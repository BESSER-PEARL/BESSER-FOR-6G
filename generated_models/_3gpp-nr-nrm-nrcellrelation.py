...
NRCellRelationGrp = Class(name="NRCellRelationGrp")
...
NRCellRelation.attributes={NRCellRelation_nRFreqRelationRef, NRCellRelation_adjacentNRCellRef, NRCellRelation_nRTCI, NRCellRelation_isRemoveAllowed, NRCellRelation_isESCoveredBy, NRCellRelation_isHOAllowed}

# NRCellRelationGrp class attributes and methods
NRCellRelationGrp_nRTCI: Property = Property(name="nRTCI", type=IntegerType)
NRCellRelationGrp_nRFreqRelationRef: Property = Property(name="nRFreqRelationRef", type=types3gpp:DistinguishedName)
NRCellRelationGrp_adjacentNRCellRef: Property = Property(name="adjacentNRCellRef", type=types3gpp:DistinguishedName)
NRCellRelationGrp_isRemoveAllowed: Property = Property(name="isRemoveAllowed", type=BooleanType)
NRCellRelationGrp_isHOAllowed: Property = Property(name="isHOAllowed", type=BooleanType)
NRCellRelationGrp_isESCoveredBy: Property = Property(name="isESCoveredBy", type=EnergySavingCoverage)
NRCellRelationGrp.attributes={NRCellRelationGrp_nRFreqRelationRef, NRCellRelationGrp_adjacentNRCellRef, NRCellRelationGrp_nRTCI, NRCellRelationGrp_isRemoveAllowed, NRCellRelationGrp_isESCoveredBy, NRCellRelationGrp_isHOAllowed}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-nrcellrelation",
    types={NRCellRelation, NRCellRelationGrp, types3gpp_model, mf3gpp_model, me3gpp_model, top3gpp_model, types5g3gpp_model, inet_model, subnet3gpp_model, Conf5QIs3gpp_model, eprp3gpp_model, af3gpp_model, amf3gpp_model, ausf3gpp_model, dn3gpp_model, lmf3gpp_model, n3iwf3gpp_model, ngeir3gpp_model, nrf3gpp_model, nssf3gpp_model, pcf3gpp_model, sepp3gpp_model, smf3gpp_model, smsf3gpp_model, udm3gpp_model, upf3gpp_model, yang_model, nfs3gpp_model, nfp3gpp_model, meas3gpp_model, subscr3gpp_model, fm3gpp_model, trace3gpp_model, yangmnt_model, cbeamff3gpp_model, gnbdu3gpp_model, nrsectcarr3gpp_model, nrcellcu3gpp_model, gnbcucp3gpp_model, nrcelldu3gpp_model, gnbcuup3gpp_model, eutranet3gpp_model, nrnet3gpp_model, extenb3gpp_model, extgnbcucp3gpp_model, nrrrmpolicy3gpp_model},
    associations={},
    generalizations={}
)
