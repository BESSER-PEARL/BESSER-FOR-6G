...
NRSectorCarrier_sectorEquipmentFunctionRef: Property = Property(name="sectorEquipmentFunctionRef", type=types3gpp_model.get_type_by_name('DistinguishedName'), synonyms=["Reference to corresponding SectorEquipmentFunction instance."])
NRSectorCarrier_txDirection: Property = Property(name="txDirection", type=types3gpp_model.get_type_by_name('TxDirection'), synonyms=["Indicates if the transmission direction is downlink, uplink, or both downlink and uplink."])
