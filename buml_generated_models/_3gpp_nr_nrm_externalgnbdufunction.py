...
ExternalGNBDUFunction_pLMNId: Property = Property(name="pLMNId", type=DataType('PLMNId'), multiplicity=Multiplicity(1, "*"), synonyms=["Specifies the PLMN identifier to be used as part of the global RAN node identity."])
