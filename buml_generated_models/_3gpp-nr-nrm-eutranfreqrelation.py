...
EUtranFreqRelation_cellIndividualOffset: Property = Property(name="cellIndividualOffset", type=types3gpp_model.get_type_by_name('QOffsetRange'), synonyms=["Offset applicable to a neighbouring cell. Used for evaluating the neighbouring cell for handover in connected mode. Used by the HandOver parameter Optimization (HOO) function or Load Balancing Optimization (LBO) function."])
...
EUtranFreqRelation_eUtranFrequencyRef: Property = Property(name="eUtranFrequencyRef", type=types3gpp_model.get_type_by_name('DistinguishedName'), synonyms=["Reference to a corresponding EUtranFrequency instance."])
