...
Configurable5QISetSubtree_Configurable5QISet: Property = Property(name="Configurable5QISet", type=list, synonyms=["Specifies the non-standardized 5QIs, including their QoS characteristics, that need to be pre-configured (and configurable) to the 5G NFs, see 3GPP TS 23.501."])
