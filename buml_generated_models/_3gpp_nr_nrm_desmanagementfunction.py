...
EnergysavingstateEnum.synonyms = ["Specifies the status regarding the energy saving in the cell."]

IsprobingcapableEnum = Enumeration(name="IsprobingcapableEnum")
IsprobingcapableEnum_no = EnumerationLiteral(name="no", owner=IsprobingcapableEnum)
IsprobingcapableEnum_yes = EnumerationLiteral(name="yes", owner=IsprobingcapableEnum)
IsprobingcapableEnum.literals = {IsprobingcapableEnum_no, IsprobingcapableEnum_yes}
IsprobingcapableEnum.synonyms = ["This attribute indicates whether this cell is capable of performing the ES probing procedure."]
...
DESManagementFunction_energySavingState: Property = Property(name="energySavingState", type=EnergysavingstateEnum, synonyms=["Specifies the status regarding the energy saving in the cell."])
DESManagementFunction_esNotAllowedTimePeriod: Property = Property(name="esNotAllowedTimePeriod", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attribute indicates a list of time periods during which inter-RAT energy saving is not allowed."])
DESManagementFunction_interRatEsActivationCandidateCellParameters: Property = Property(name="interRatEsActivationCandidateCellParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attribute indicates the traffic load threshold and the time duration, which are used by distributed inter-RAT ES algorithms to allow an original cell to enter the energySaving state."])
DESManagementFunction_interRatEsActivationOriginalCellParameters: Property = Property(name="interRatEsActivationOriginalCellParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attribute indicates the traffic load threshold and the time duration, which are used by distributed inter-RAT ES algorithms to allow an original cell to enter the energySaving state."])
DESManagementFunction_interRatEsDeactivationCandidateCellParameters: Property = Property(name="interRatEsDeactivationCandidateCellParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attribute indicates the traffic load threshold and the time duration which is used by distributed inter-RAT ES algorithms to allow an original cell to leave the energySaving state."])
DESManagementFunction_intraRatEsActivationCandidateCellsLoadParameters: Property = Property(name="intraRatEsActivationCandidateCellsLoadParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attribute indicates the traffic load threshold and the time duration, which are used by distributed ES algorithms level to allow a n 'original' cell to enter the energySaving state."])
DESManagementFunction_intraRatEsActivationOriginalCellLoadParameters: Property = Property(name="intraRatEsActivationOriginalCellLoadParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attributes is relevant, if the cell acts as an original cell.This attribute indicates the traffic load threshold and the time duration, which are used by distributed ES algorithms to allow a cell to enter the energySaving state."])
DESManagementFunction_intraRatEsDeactivationCandidateCellsLoadParameters: Property = Property(name="intraRatEsDeactivationCandidateCellsLoadParameters", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This attributes is relevant, if the cell acts as a candidate cell.This attribute indicates the traffic load threshold and the time duration which is used by distributed ES algorithms to allow a cell to leave the energySaving state."])
DESManagementFunction_isProbingCapable: Property = Property(name="isProbingCapable", type=IsprobingcapableEnum, synonyms=["This attribute indicates whether this cell is capable of performing the ES probing procedure."])
...
domain_model = DomainModel(
    ...
    types={DESManagementFunction, EnergysavingstateEnum, EsNotAllowedTimePeriod, InterRatEsActivationCandidateCellParameters, InterRatEsActivationOriginalCellParameters, InterRatEsDeactivationCandidateCellParameters, IntraRatEsActivationCandidateCellsLoadParameters, IntraRatEsActivationOriginalCellLoadParameters, IntraRatEsDeactivationCandidateCellsLoadParameters, IsprobingcapableEnum},
    associations={},
    generalizations={}
)
