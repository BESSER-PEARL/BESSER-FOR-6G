...
NtfSubscriptionControl_scope: Property = Property(name="scope", type=list, synonyms=["Describes which object instances are selected with respect to a base object instance."])
