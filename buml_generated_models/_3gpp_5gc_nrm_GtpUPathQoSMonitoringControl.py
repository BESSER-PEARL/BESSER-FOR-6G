...
GtpUPathQoSMonitoringControl = Class(name="GtpUPathQoSMonitoringControl", synonyms=["Represents the GtpUPathQoSMonitoringControl IOC."])

# GtpUPathQoSMonitoringControl class attributes and methods
GtpUPathQoSMonitoringControl_GtpUPathQoSMonitoringControl: Property = Property(name="GtpUPathQoSMonitoringControl", type=DataType('Top_Grp'), multiplicity=Multiplicity(0, "*"), synonyms=["Specifies the capabilities and properties for control of GTP-U path QoS monitoring. For more information about the GTP-U path QoS monitoring."])
...
GtpUPathQoSMonitoringControl_gtpUPathMonitoredSNSSAIs: Property = Property(name="gtpUPathMonitoredSNSSAIs", type=DataType('SNssai'), multiplicity=Multiplicity(0, "*"), synonyms=["The S-NSSAIs for which the the GTP-U path QoS monitoring is to be performed."])
