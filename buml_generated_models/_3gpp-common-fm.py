...
AlarmList_administrativeState: Property = Property(name="administrativeState", type=StringType, synonyms=["When set to UNLOCKED, the alarm list is updated. When the set to LOCKED, the existing alarm records are not updated, and new alarm records are not added to the alarm list."])
AlarmList_alarmRecords: Property = Property(name="alarmRecords", type=list, synonyms=["List of alarmRecords"])
AlarmList_lastModification: Property = Property(name="lastModification", type=StringType, synonyms=["The last time when an alarm record was modified"])
...
AlarmList_operationalState: Property = Property(name="operationalState", type=StringType, synonyms=["The producer sets this attribute to ENABLED, indicating that it has the resource and ability to record alarm in AlarmList else, it sets the attribute to DISABLED."])
...
AlarmRecord_ackTime: Property = Property(name="ackTime", type=StringType, synonyms=["It identifies the time when the alarm has been acknowledged or unacknowledged the last time, i.e. it registers the time when ackState changes."])
...
AlarmRecord_alarmChangedTime: Property = Property(name="alarmChangedTime", type=StringType, synonyms=["not applicable if related alarm has not changed"])
AlarmRecord_alarmClearedTime: Property = Property(name="alarmClearedTime", type=StringType, synonyms=["not applicable if related alarm was not cleared"])
