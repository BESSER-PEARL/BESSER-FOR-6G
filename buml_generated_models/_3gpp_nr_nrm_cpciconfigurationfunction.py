...
CPCIConfigurationFunction_cSonPciList: Property = Property(name="cSonPciList", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["This holds a list of physical cell identities that can be assigned to the pci attribute by gNB. The assignment algorithm is not specified. This attribute shall be supported if and only if the C-SON PCI configuration is supported."])
