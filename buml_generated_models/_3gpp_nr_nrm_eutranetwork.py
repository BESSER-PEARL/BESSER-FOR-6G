...
EUtraNetwork_EUtraNetwork: Property = Property(name="EUtraNetwork", type=DataType('Top_Grp'), multiplicity=Multiplicity(0, "*"), synonyms=["A subnetwork containing gNB external E-UTRAN entities."])
