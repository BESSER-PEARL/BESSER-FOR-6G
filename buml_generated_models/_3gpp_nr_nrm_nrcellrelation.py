...
# Classes
NRCellRelation = Class(name="NRCellRelation", synonyms=["Represents the NRCellRelation IOC."])

# NRCellRelation class attributes and methods
NRCellRelation_NRCellRelation: Property = Property(name="NRCellRelation", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["Represents a neighbour cell relation from a source cell to a target cell, where the target cell is an NRCellCU or ExternalNRCellCU instance."])
NRCellRelation_adjacentNRCellRef: Property = Property(name="adjacentNRCellRef", type=DataType('DistinguishedName'), synonyms=["Reference to an adjacent NR cell (NRCellCU or ExternalNRCellCU)."])
...
NRCellRelation_nRFreqRelationRef: Property = Property(name="nRFreqRelationRef", type=DataType('DistinguishedName'), synonyms=["Reference to a corresponding NRFreqRelation instance."])
...
NRCellRelation.attributes={NRCellRelation_NRCellRelation, NRCellRelation_adjacentNRCellRef, NRCellRelation_isESCoveredBy, NRCellRelation_isHOAllowed, NRCellRelation_isRemoveAllowed, NRCellRelation_nRFreqRelationRef, NRCellRelation_nRTCI}
