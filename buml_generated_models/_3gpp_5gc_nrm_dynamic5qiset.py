...
Dynamic5QISet_dynamic5QIs: Property = Property(name="dynamic5QIs", type=DataType('FiveQICharacteristics'), multiplicity=Multiplicity(0, "*"), synonyms=["Represents the Dynamic5QISet IOC."])
...
Dynamic5QISetSubtree_Dynamic5QISet: Property = Property(name="Dynamic5QISet", type=DataType('Top_Grp'), multiplicity=Multiplicity(0, "*"), synonyms=["Specifies the dynamic 5QIs including their QoS characteristics, see 3GPP TS 23.501."])
