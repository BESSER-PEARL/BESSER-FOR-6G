...
RRMPolicyRatio_RRMPolicyRatio: Property = Property(name="RRMPolicyRatio", type=list, synonyms=["The RRMPolicyRatio IOC is one realization of a RRMPolicy_ IOC, see the inheritance in Figure 4.2.1.2-1. This RRM framework allows adding new policies, both standardized (like RRMPolicyRatio) or as vendor specific, by inheriting from the abstract RRMPolicy_ IOC. For details see subclause 4.3.36."])
...
RRMPolicy__rRMPolicyMemberList: Property = Property(name="rRMPolicyMemberList", type=list, synonyms=["It represents the list of RRMPolicyMember (s) that the managed object is supporting. A RRMPolicyMember <<dataType>> include the PLMNId <<dataType>> and S-NSSAI <<dataType>>."])
