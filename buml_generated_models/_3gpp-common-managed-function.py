...
ManagedFunction_peeParametersList: Property = Property(name="peeParametersList", type=list, synonyms=["Contains the parameter set for the control and monitoring of power, energy and environmental parameters of ManagedFunction instance(s)."])
ManagedFunction_priorityLabel: Property = Property(name="priorityLabel", type=IntegerType)
ManagedFunction_vnfParametersList: Property = Property(name="vnfParametersList", type=list, synonyms=["Contains the parameter set of the VNF instance(s) corresponding to an NE. The presence of this list indicates that the ManagedFunction represented is realized by one or more VNF instance(s). Otherwise it shall be absent. The presence of a vnfParametersList entry, whose vnfInstanceId with a string length of zero, in createMO operation can trigger the instantiation of the related VNF/VNFC instances."])
...
ManagedFunctionContainedClasses_ManagedNFService: Property = Property(name="ManagedNFService", type=list, synonyms=["Represents a Network Function (NF)"])
...
ManagedNFService_administrativeState: Property = Property(name="administrativeState", type=StringType, synonyms=["Permission to use or prohibition against using the instance"])
...
ManagedNFService_operationalState: Property = Property(name="operationalState", type=StringType, synonyms=["Describes whether the resource is installed and working"])
ManagedNFService_operations: Property = Property(name="operations", type=list, synonyms=["Set of operations supported by the managed NF service instance"])
ManagedNFService_registrationState: Property = Property(name="registrationState", type=EnumerationType)
ManagedNFService_sAP: Property = Property(name="sAP", type=list, synonyms=["The service access point of the managed NF service instance"])
ManagedNFService_usageState: Property = Property(name="usageState", type=StringType, synonyms=["Describes whether the resource is actively in use at a specific instant, and if so, whether or not it has spare capacity for additional users."])
