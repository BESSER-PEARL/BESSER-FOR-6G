...
EP_Common_localAddress: Property = Property(name="localAddress", type=DataType('AddressWithVlan'), multiplicity=Multiplicity(1, "*"), synonyms=["Local IP address and VLAN ID."])
EP_Common_remoteAddress: Property = Property(name="remoteAddress", type=DataType('ip_address'), synonyms=["Remote IP address."])
...
EP_RP_farEndEntity: Property = Property(name="farEndEntity", type=DataType('DistinguishedName'))
