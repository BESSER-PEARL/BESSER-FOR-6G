...
NRCellDU_administrativeState: Property = Property(name="administrativeState", type=types3gpp_model.get_type_by_name('AdministrativeState'), synonyms=["Administrative state of the NRCellDU. Indicates the permission to use or prohibition against using the cell, imposed through the OAM services."])
...
NRCellDU_cellState: Property = Property(name="cellState", type=types3gpp_model.get_type_by_name('CellState'), synonyms=["Cell state of the NRCellDU instance. Indicates whether the cell is not currently in use (IDLE), or currently in use but not configured to carry traffic (INACTIVE), or currently in use and is configured to carry traffic (ACTIVE)."])
NRCellDU_nRPCI: Property = Property(name="nRPCI", type=IntegerType, synonyms=["The Physical Cell Identity (PCI) of the NR cell."])
NRCellDU_nRTAC: Property = Property(name="nRTAC", type=types3gpp_model.get_type_by_name('Tac'), synonyms=["The common 5GS Tracking Area Code for the PLMNs."])
NRCellDU_operationalState: Property = Property(name="operationalState", type=types3gpp_model.get_type_by_name('OperationalState'), synonyms=["Operational state of the NRCellDU instance. Indicates whether the resource is installed and partially or fully operable (ENABLED) or the resource is not installed or not operable (DISABLED)."])
NRCellDU_pLMNInfoList: Property = Property(name="pLMNInfoList", type=types5g3gpp_model.get_type_by_name('PLMNInfo'), multiplicity=Multiplicity(1, "*"), synonyms=["The PLMNInfoList is a list of PLMNInfo data type. It defines which PLMNs that can be served by the NR cell, and which S-NSSAIs that can be supported by the NR cell for corresponding PLMN in case of network slicing feature is supported. The plMNId of the first entry of the list is the PLMNId used to construct the nCGI for the NR cell."])
