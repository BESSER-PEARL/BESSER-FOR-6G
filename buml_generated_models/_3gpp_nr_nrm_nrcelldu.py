...
# Classes
NRCellDU = Class(name="NRCellDU", synonyms=["Represents the NRCellDU IOC."])

# NRCellDU class attributes and methods
NRCellDU_NRCellDU: Property = Property(name="NRCellDU", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["Represents the information of a cell known by DU."])
NRCellDU_administrativeState: Property = Property(name="administrativeState", type=AdministrativeState, synonyms=["Administrative state of the NRCellDU. Indicates the permission to use or prohibition against using the cell, imposed through the OAM services."])
...
NRCellDU_cellState: Property = Property(name="cellState", type=CellState, synonyms=["Cell state of the NRCellDU instance. Indicates whether the cell is not currently in use (IDLE), or currently in use but not configured to carry traffic (INACTIVE), or currently in use and is configured to carry traffic (ACTIVE)."])
...
NRCellDU_operationalState: Property = Property(name="operationalState", type=OperationalState, synonyms=["Operational state of the NRCellDU instance. Indicates whether the resource is installed and partially or fully operable (ENABLED) or the resource is not installed or not operable (DISABLED)."])
