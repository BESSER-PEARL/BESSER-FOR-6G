...
EUtranCellRelation_adjacentCell: Property = Property(name="adjacentCell", type=types3gpp_model.get_type_by_name('DistinguishedName'), synonyms=["Reference to an EUtranCellFDD/TDD or ExternalEUtranCellFDD/TDD instance."])
EUtranCellRelation_cellIndividualOffset: Property = Property(name="cellIndividualOffset", type=types3gpp_model.get_type_by_name('QOffsetRange'), synonyms=["Offset applicable to a neighbouring cell. It is used for evaluating the neighbouring cell for handover in connected mode. Used by the HandOver parameter Optimization (HOO) function or Load Balancing Optimization (LBO) function."])
...
EUtranCellRelation_qOffset: Property = Property(name="qOffset", type=types3gpp_model.get_type_by_name('QOffsetRange'), synonyms=["Offset applicable to a specific neighbouring cell used for evaluating the cell as a candidate for cell re-selection. Corresponds to parameter q-OffsetCell broadcast in SIB4 for intra-frequency cells and in SIB5 for inter-frequency cells. Used for Mobility Robustness Optimization."])
