...
GNBCUUPFunction = Class(name="GNBCUUPFunction", synonyms=["Represents the GNBCUUPFunction IOC."])

# GNBCUUPFunction class attributes and methods
GNBCUUPFunction_GNBCUUPFunction: Property = Property(name="GNBCUUPFunction", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["Represents the logical function CU-UP of gNB or en-gNB."])
GNBCUUPFunction_configurable5QISetRef: Property = Property(name="configurable5QISetRef", type=DataType('DistinguishedName'), synonyms=["DN of the Configurable5QISet that the GNBCUUPFunction supports (is associated to)."])
GNBCUUPFunction_dynamic5QISetRef: Property = Property(name="dynamic5QISetRef", type=DataType('DistinguishedName'), synonyms=["DN of the Dynamic5QISet that the GNBCUUPFunction supports (is associated to)."])
...
GNBCUUPFunction_pLMNInfoList: Property = Property(name="pLMNInfoList", type=DataType('PLMNInfo'), multiplicity=Multiplicity(0, "*"), synonyms=["The PLMNInfoList is a list of PLMNInfo data type. It defines which PLMNs that can be served by the GNBCUUPFunction and which S-NSSAIs can be supported by the GNBCUUPFunction for corresponding PLMN in case of network slicing feature is supported"])
GNBCUUPFunction.attributes={GNBCUUPFunction_GNBCUUPFunction, GNBCUUPFunction_configurable5QISetRef, GNBCUUPFunction_dynamic5QISetRef, GNBCUUPFunction_gNBCUUPId, GNBCUUPFunction_gNBId, GNBCUUPFunction_gNBIdLength, GNBCUUPFunction_mappingSetIDBackhaulAddressList, GNBCUUPFunction_pLMNInfoList}
...
TAI_pLMNId: Property = Property(name="pLMNId", type=DataType('PLMNId'), multiplicity=Multiplicity(0, "*"), synonyms=["PLMN IDs for the Tracking area"])
