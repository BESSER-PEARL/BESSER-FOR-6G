...
TraceJob_tjMDTPLMList: Property = Property(name="tjMDTPLMList", type=DataType('PLMNId'), multiplicity=Multiplicity(1, "*"), synonyms=["It indicates the PLMNs where measurement collection, status indication and log reporting is allowed."])
