...
# Classes
NRFreqRelation = Class(name="NRFreqRelation", synonyms=["Represents the NRFreqRelation IOC."])

# NRFreqRelation class attributes and methods
NRFreqRelation_NRFreqRelation: Property = Property(name="NRFreqRelation", type=list, multiplicity=Multiplicity(0, "*"), synonyms=["Together with the target NRFrequency, it represents the frequency properties applicable to the referencing NRFreqRelation."])
...
NRFreqRelation_nRFrequencyRef: Property = Property(name="nRFrequencyRef", type=DataType('DistinguishedName'), synonyms=["Reference to a corresponding NRFrequency instance."])
...
NRFreqRelation_qOffsetFreq: Property = Property(name="qOffsetFreq", type=DataType('QOffsetRange'), synonyms=["The frequency specific offset applied when evaluating candidates for cell reselection."])
