...
CommonBeamformingFunctionGrp = Class(name="CommonBeamformingFunctionGrp", synonyms=["Represents the CommonBeamformingFunction IOC."])

# CommonBeamformingFunctionGrp class attributes and methods
CommonBeamformingFunctionGrp_coverageShape: Property = Property(name="coverageShape", type=IntegerType, synonyms=["Identifies the sector carrier coverage shape described by the envelope of the contained SSB beams. The coverage shape is implementation dependent."])
CommonBeamformingFunctionGrp_digitalAzimuth: Property = Property(name="digitalAzimuth", type=IntegerType, synonyms=["Digitally-controlled azimuth through beamforming. It represents the horizontal pointing direction of the antenna relative to the antenna bore sight, representing the total non-mechanical horizontal pan of the selected coverageShape. Positive value gives azimuth to the right and negative value gives an azimuth to the left."])
CommonBeamformingFunctionGrp_digitalTilt: Property = Property(name="digitalTilt", type=IntegerType, synonyms=["Digitally-controlled tilt through beamforming. It represents the vertical pointing direction of the antenna relative to the antenna bore sight, representing the total non-mechanical vertical tilt of the selected coverageShape. Positive value gives downwards tilt and negative value gives upwards tilt."])
CommonBeamformingFunctionGrp.attributes={CommonBeamformingFunctionGrp_coverageShape, CommonBeamformingFunctionGrp_digitalAzimuth, CommonBeamformingFunctionGrp_digitalTilt}

# Domain Model with References
domain_model = DomainModel(
    name="_3gpp-nr-nrm-commonbeamformingfunction",
    types={CommonBeamformingFunction, CommonBeamformingFunctionGrp},
    associations={},
    generalizations={}
)
